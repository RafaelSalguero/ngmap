...
(function () {
    ...
    var __MapController = function (
        ...
        vm.initializeMap = function () {
            ...
            //El disable init deshabilita la creacion del mapa si el scope es destruido, si no al alternar entre vistas que tienen y no tienen mapa es posible que se 
            //inicialize un mapa despues de que los controles fueron creados, causando problemas.

            //Lo mismo pasa con los controles
...
(function () {
    ...
    var linkFunc = function (scope, element, attrs, mapController) {
        ...
        //Agregar soporte de custom control a mapas con Id:
        var parentId = element[0].parentElement.id;
        var getArg = null;
        if (parentId) {
            getArg = { id: parentId };
        }

        //Si el control es destruido marca una bandera indicando que se debe de cancelar la creacion del mismo
        var cancelCreation = false;
        scope.$on('$destroy', function () {
            cancelCreation = true;
        });
        ...
        NgMap.getMap(getArg).then(function (map) {
            if (!cancelCreation) {
...
(function () {
    ...
    var getMap = function (options) {
        ...
        function waitForMap(timeElapsed) {
            ...
            var ids = [];
            for (var name in mapControllers) {
                ids.push(name);
            }
